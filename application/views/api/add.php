	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<?php echo form_open('api/add', array("class" => "form-horizontal")); ?>
					...
					<div class="col-md-8">
						<select name="method" class="form-control">
							...
							foreach ($method_values as $value => $display_text) {
								$selected = ($value == $this->input->post('method')) ? ' selected="selected"' : "";
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="api_name" value="<?php echo $this->input->post('api_name'); ?>" class="form-control" id="api_name" />
