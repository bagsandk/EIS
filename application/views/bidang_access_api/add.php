	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<?php echo form_open('bidang_access_api/add', array("class" => "form-horizontal")); ?>
					...
					<div class="col-md-8">
						<select name="bidang_id" class="form-control">
							...
							foreach ($all_bidangs as $bidang) {
								$selected = ($bidang['id'] == $this->input->post('bidang_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-8">
						<select name="api_id" class="form-control">
							...
							foreach ($all_apis as $api) {
								$selected = ($api['id'] == $this->input->post('api_id')) ? ' selected="selected"' : "";
