	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<?php echo form_open('user_access_menu/edit/' . $user_access_menu['id'], array("class" => "form-horizontal")); ?>
					...
					<div class="col-md-8">
						<select name="role_id" class="form-control">
							...
							foreach ($all_user_roles as $user_role) {
								$selected = ($user_role['id'] == $user_access_menu['role_id']) ? ' selected="selected"' : "";
